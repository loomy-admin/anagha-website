...
function GoogleContinueButtonInner({
  ...
  return (
    <button
      ...
      disabled={disabled}
      onClick={() => login()}
      className="flex h-[52px] w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white text-[15px] font-medium text-[#3c4043] shadow-sm transition-colors hover:border-navy/20 hover:bg-[#fafafa] disabled:cursor-not-allowed disabled:opacity-60"
    >
      <GoogleMark />
      {label}
    </button>
